...
updates:
  - date: 2025-02-19
    note: >-
      I'm back at it again, this time measuring
      [S3's Lifecycle latency](/s3-lifecycle/).
  - date: 2025-01-01
    note: >-
      I've updated the graph to include the last update time. Expect it to be a
      minute or two behind the current time.
  - date: 2024-12-06
    note: >-
      I [posted this to Reddit](https://www.reddit.com/r/aws/comments/1h4czru/dynamodbs_ttl_latency/)
      and it garnered some good discussion. I've also written up
      [an in-depth post](/ddb-ttl-how-to/) taking a look at how I produced that
      graph.
---
